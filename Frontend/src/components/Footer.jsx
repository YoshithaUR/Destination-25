      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div 
            ...
            data-aos-once="true"
          >
            <h3 className="text-2xl font-bold mb-4 text-yellow-400">Ceylon Infinite Destinations</h3>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/1XjEbgs2kd/?mibextid=qi2Omg" className="text-gray-300 hover:text-yellow-400 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              {/* Instragram */}
              <a href="https://www.instagram.com/ceyloninfinite/" className="text-gray-300 hover:text-yellow-400 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/106268570/admin/dashboard/" className="text-gray-300 hover:text-yellow-400 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          >
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
