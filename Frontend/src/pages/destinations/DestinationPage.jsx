  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <div className="fixed top-32 left-6 z-50">
        <button
          onClick={() => navigate(-1)}
          className="bg-black/70 hover:bg-red-900 text-white hover:text-black w-16 h-16 rounded-full transition duration-300 transform hover:scale-110 flex items-center justify-center shadow-lg hover:shadow-2xl hover:shadow-red-900/50"
          aria-label="Go back"
        >
