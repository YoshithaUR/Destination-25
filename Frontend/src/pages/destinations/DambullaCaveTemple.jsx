...
const DambullaTemple = () => {
  ...
  const destination = {
    ...
    gallery: [
      ...
      "https://source.unsplash.com/1200x800/?buddha,statue,srilanka",
    ],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <section className="relative h-[600px] flex items-center justify-center" data-aos="fade-in">
        <div
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <p className="text-2xl text-gray-300 max-w-3xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="200">
            {destination.description}
          </p>
          <div className="flex justify-center items-center space-x-4" data-aos="fade-up" data-aos-delay="400">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto" data-aos="fade-up">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold mb-6 text-red-900">Discover {destination.name}</h2>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">{destination.longDescription}</p>
      ...
      <section className="py-16 px-6 bg-gray-900/50" data-aos="fade-up">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-red-900">Why Visit {destination.name}?</h2>
            ...
            {destination.detailedInfo.map((info, index) => (
              ...
              >
                <div className={`${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
                  ...
                  <p className="text-gray-300 text-lg mb-6 leading-relaxed">{info.content}</p>
                  <button className="mt-4 bg-white hover:bg-yellow-600 text-gray-900 font-bold py-3 px-6 rounded-lg transition duration-300">
                    Learn More
                  </button>
                </div>
      ...
      <section className="py-16 px-6 bg-gray-900/50" data-aos="fade-up">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-red-900">Activities & Experiences</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {destination.activities.map((activity, index) => (
              <div key={index} className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-red-900/10 transition duration-300 group">
